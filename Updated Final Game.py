...
class GameView(arcade.View):
    ...
    def setup(self):
        ...
        #Set-up sounds
        self.jump_sound = arcade.Sound(":resources:sounds/phaseJump1.wav", TILE_SCALING)
        self.slide_sound = arcade.Sound(":resources:sounds/hit5.wav", TILE_SCALING)
        self.point_sound = arcade.Sound(":resources:sounds/coin1.wav", TILE_SCALING)
        ...
        x_coord = random.randrange(100, WIDTH)
        ...
        for coordinate in coordinate_list:
            ...
            self.scene.add_sprite("obstacle", wall)
        ...
        #     self.scene.add_sprite("obstacle", crate)
    ...
    def on_update(self, delta_time):
        ...
        if self.timer <= 0:
            wall = arcade.Sprite(":resources:images/tiles/cactus.png", TILE_SCALING)
            first = round(self.player_sprite.center_x + 400)
            last = round(self.player_sprite.center_x + 900)
            x_coord = random.randrange(first, last)
        ...
        hit_list = arcade.check_for_collision_with_list(
            self.player_sprite, self.scene.get_sprite_list("obstacle")
        )
